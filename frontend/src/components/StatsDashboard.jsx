...
const StatsDashboard = () => {
    ...
    return (
      ...
      deadline < new Date() // Compare la deadline à la date actuelle
        ...
        setStats({
          ...
          overdueTasks,
          totalClients,
          totalMessages, // Laissez ce champ si des messages seront ajoutés plus tard
        });
      } catch (err) {
  ...
  const dynamicStats = [
    ...
    { icon: <FaShoppingCart />, value: stats.totalClients, label: "Clients", color: "#007bff" },
    { icon: <FaUsers />, value: stats.totalMessages, label: "Messages", color: "#6f42c1" },
  ];
